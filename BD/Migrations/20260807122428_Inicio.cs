    ...
    public partial class Inicio : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TiposCobro", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngresosProveedor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IngresosProveedor_Proveedores_ProveedorId",
            ...
            migrationBuilder.CreateTable(
                name: "DetallesIngresoProveedor",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProductoId = table.Column<int>(type: "integer", nullable: false),
                    IngresoProveedorId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesIngresoProveedor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetallesIngresoProveedor_IngresosProveedor_IngresoProveedor~",
                        column: x => x.IngresoProveedorId,
                        principalTable: "IngresosProveedor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetallesIngresoProveedor_Productos_ProductoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfertasProductos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfertasProductos_Ofertas_OfertaId",
                        column: x => x.OfertaId,
                        principalTable: "Ofertas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OfertasProductos_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CobrosMetodoPago", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CobrosMetodoPago_Cobros_CobroId",
                        column: x => x.CobroId,
                        principalTable: "Cobros",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CobrosMetodoPago_TiposCobro_TipoCobroId",
                        column: x => x.TipoCobroId,
                        principalTable: "TiposCobro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetallesCarrito_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "LogsEstadoCarrito",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CarritoId = table.Column<int>(type: "integer", nullable: false),
                    EstadoCarrito = table.Column<int>(type: "integer", nullable: false),
                    Fecha = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogsEstadoCarrito", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogsEstadoCarrito_Carritos_CarritoId",
                        column: x => x.CarritoId,
                        principalTable: "Carritos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fecha = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Total = table.Column<decimal>(type: "numeric", nullable: false),
                    MontoAdeudado = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoCobroId = table.Column<int>(type: "integer", nullable: false),
                    Monto = table.Column<decimal>(type: "numeric", nullable: false),
                    Observaciones = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovimientosCuentaCorriente_Cobros_CobroId",
                        column: x => x.CobroId,
                        principalTable: "Cobros",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CobrosMetodoPago_CobroId",
                table: "CobrosMetodoPago",
                column: "CobroId");

            migrationBuilder.CreateIndex(
                name: "IX_CobrosMetodoPago_TipoCobroId",
                table: "CobrosMetodoPago",
                column: "TipoCobroId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesCarrito_ProductoId",
                table: "DetallesCarrito",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "DetalleIngresoProveedor_IngresoProveedorId_ProductoId_UQ",
                table: "DetallesIngresoProveedor",
                columns: new[] { "IngresoProveedorId", "ProductoId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DetallesIngresoProveedor_ProductoId",
                table: "DetallesIngresoProveedor",
                column: "ProductoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngresosProveedor_ProveedorId",
                table: "IngresosProveedor",
                column: "ProveedorId");

            migrationBuilder.CreateIndex(
                name: "IX_LogsEstadoCarrito_CarritoId",
                table: "LogsEstadoCarrito",
                column: "CarritoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovimientosCuentaCorriente_CobroId",
                table: "MovimientosCuentaCorriente",
                column: "CobroId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfertasProductos_ProductoId",
                table: "OfertasProductos",
                column: "ProductoId");
            ...
            migrationBuilder.CreateIndex(
                name: "ProductoCategoria_CategoriaId_ProductoId_UQ",
                table: "ProductoCategorias",
